...
function Register() {
    ...
    return (
        <div style={{ padding: '20px', backgroundColor: '#2c3e50', borderRadius: '10px', boxShadow: '0 4px 8px rgba(0,0,0,0.1)', maxWidth: '500px', margin: '20px auto', height: "310px", overflow: "hidden" }}>
            <h2 style={{ textAlign: 'center', marginBottom: '20px', color: '#ecf0f1', fontSize: "24px" }}><b>Register</b></h2>
