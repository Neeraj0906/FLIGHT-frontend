...
function Register() {
    ...
    return (
        <div style={{ padding: '40px', backgroundColor: '#f9f9f9', borderRadius: '10px', boxShadow: '0 4px 8px rgba(0,0,0,0.1)', maxWidth: '400px', margin: '50px auto',marginLeft:"50px", width:"350px" }}>
